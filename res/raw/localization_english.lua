...
localization_English_table = {
    ...
    unlock_hint="Skip the passwords",
    unlock_hint_info="Use your band to unlock your device automatically when you pick it up.",
    ...
    activity_activity_format="%s %s worked out for %s",
    ...
    cannot_find_bracelet="Can't detect your band",
