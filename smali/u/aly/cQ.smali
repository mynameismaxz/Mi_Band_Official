...
.method private static a(Lu/aly/cy;Lu/aly/cj;)V
    .locals 2

    const/4 v0, 0x0

    iput-object v0, p1, Lu/aly/cj;->c:Lu/aly/cg;

    iput-object v0, p1, Lu/aly/cj;->b:Ljava/lang/Object;
    ...
    invoke-virtual {p1, p0, v0}, Lu/aly/cj;->a(Lu/aly/cy;Lu/aly/ct;)Ljava/lang/Object;

    move-result-object v1

    iput-object v1, p1, Lu/aly/cj;->b:Ljava/lang/Object;

    iget-object v1, p1, Lu/aly/cj;->b:Ljava/lang/Object;

    if-eqz v1, :cond_0

    iget-short v0, v0, Lu/aly/ct;->c:S

    invoke-virtual {p1, v0}, Lu/aly/cj;->b(S)Lu/aly/cg;
...
.method private static b(Lu/aly/cy;Lu/aly/cj;)V
    .locals 2

    invoke-virtual {p1}, Lu/aly/cj;->j()Lu/aly/cg;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {p1}, Lu/aly/cj;->k()Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {p1}, Lu/aly/cj;->c()Lu/aly/dd;
    ...
    invoke-virtual {p1, v0}, Lu/aly/cj;->a(Lu/aly/cg;)Lu/aly/ct;

    move-result-object v0

    invoke-virtual {p0, v0}, Lu/aly/cy;->a(Lu/aly/ct;)V

    invoke-virtual {p1, p0}, Lu/aly/cj;->c(Lu/aly/cy;)V
