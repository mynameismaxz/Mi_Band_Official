...
.method private static a(Lu/aly/cy;Lu/aly/ao;)V
    .locals 3
    ...
    invoke-virtual {p1}, Lu/aly/ao;->m()Z
    ...
    :cond_0
    invoke-virtual {p1}, Lu/aly/ao;->p()Z
    ...
    invoke-virtual {v0, p0}, Lu/aly/az;->b(Lu/aly/cy;)V

    goto :goto_0
.end method

.method private static b(Lu/aly/cy;Lu/aly/ao;)V
    .locals 7
    ...
    iput-object v0, p1, Lu/aly/ao;->a:Ljava/lang/String;

    invoke-virtual {p1, v6}, Lu/aly/ao;->a(Z)V
    ...
    iput-object v0, p1, Lu/aly/ao;->b:Ljava/util/Map;
    ...
    invoke-virtual {p1, v6}, Lu/aly/ao;->b(Z)V

    invoke-virtual {p0}, Lu/aly/de;->x()J

    move-result-wide v2

    iput-wide v2, p1, Lu/aly/ao;->e:J

    invoke-virtual {p1, v6}, Lu/aly/ao;->e(Z)V
    ...
    iput-wide v1, p1, Lu/aly/ao;->c:J

    invoke-virtual {p1, v6}, Lu/aly/ao;->c(Z)V
    ...
    iput v0, p1, Lu/aly/ao;->d:I

    invoke-virtual {p1, v6}, Lu/aly/ao;->d(Z)V
    ...
    invoke-virtual {v4, p0}, Lu/aly/az;->a(Lu/aly/cy;)V

    iget-object v5, p1, Lu/aly/ao;->b:Ljava/util/Map;
