...
.method private static a(Lu/aly/cy;Lu/aly/ax;)V
    .locals 7
    ...
    iput v0, p1, Lu/aly/ax;->a:I

    invoke-virtual {p1, v3}, Lu/aly/ax;->a(Z)V
    ...
    iput-object v0, p1, Lu/aly/ax;->b:Ljava/lang/String;

    invoke-virtual {p1, v3}, Lu/aly/ax;->b(Z)V
    ...
    iput-object v0, p1, Lu/aly/ax;->c:Ljava/lang/String;

    invoke-virtual {p1, v3}, Lu/aly/ax;->c(Z)V
    ...
    iput-wide v0, p1, Lu/aly/ax;->d:D

    invoke-virtual {p1, v3}, Lu/aly/ax;->d(Z)V
    ...
    iput-wide v0, p1, Lu/aly/ax;->e:D

    invoke-virtual {p1, v3}, Lu/aly/ax;->e(Z)V
    ...
    iput-object v0, p1, Lu/aly/ax;->f:Ljava/lang/String;

    invoke-virtual {p1, v3}, Lu/aly/ax;->f(Z)V
    ...
    iput v0, p1, Lu/aly/ax;->g:I

    invoke-virtual {p1, v3}, Lu/aly/ax;->g(Z)V
    ...
    iput-object v0, p1, Lu/aly/ax;->h:Ljava/lang/String;

    invoke-virtual {p1, v3}, Lu/aly/ax;->h(Z)V
    ...
    iput-object v0, p1, Lu/aly/ax;->i:Lu/aly/ag;

    invoke-virtual {p1, v3}, Lu/aly/ax;->i(Z)V
    ...
    iput-object v0, p1, Lu/aly/ax;->j:Ljava/lang/String;

    invoke-virtual {p1, v3}, Lu/aly/ax;->j(Z)V
    ...
    iput-object v0, p1, Lu/aly/ax;->k:Lu/aly/bg;

    iget-object v0, p1, Lu/aly/ax;->k:Lu/aly/bg;

    invoke-virtual {v0, p0}, Lu/aly/bg;->a(Lu/aly/cy;)V

    invoke-virtual {p1, v3}, Lu/aly/ax;->k(Z)V
    ...
    invoke-virtual {p1}, Lu/aly/ax;->K()V
...
.method private static b(Lu/aly/cy;Lu/aly/ax;)V
    .locals 2
    ...
    :cond_2
    invoke-virtual {p1}, Lu/aly/ax;->o()Z
    ...
    invoke-virtual {p0, v0, v1}, Lu/aly/cy;->a(D)V

    invoke-virtual {p0}, Lu/aly/cy;->c()V

    :cond_3
    invoke-virtual {p1}, Lu/aly/ax;->r()Z
    ...
    :cond_5
    invoke-virtual {p1}, Lu/aly/ax;->x()Z
    ...
    invoke-virtual {v0, p0}, Lu/aly/bg;->b(Lu/aly/cy;)V
